...
public:
    ...
    void setupUi(QDialog *SortDialog)
    {
        ...
        splitter = new QSplitter(SortDialog);
        ...
        moreButton = new QPushButton(splitter);
        moreButton->setObjectName(QStringLiteral("moreButton"));
        moreButton->setCheckable(true);
        splitter->addWidget(moreButton);

        gridLayout_4->addWidget(splitter, 0, 1, 2, 1);
